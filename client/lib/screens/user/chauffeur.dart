...
class ChauffeurSign extends StatefulWidget {
  const ChauffeurSign({Key? key}) : super(key: key);

  @override
  State<ChauffeurSign> createState() => _ChauffeurSignState();
}

class _ChauffeurSignState extends State<ChauffeurSign> {
  File? imageFile;
  ...
  final typevoituredController = TextEditingController();
  ...
  void dispose() {
    ...
    typevoituredController.dispose();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Formulaire Chauffeur'),
        ),
        body: Container(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: const Text('Image voiture'),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Plaque voiture',
                    hintText: 'Entre ta plaque d\'immatriculation',
                    border: OutlineInputBorder(),
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                ...
                TextFormField(
                  controller: typevoituredController,
                  decoration: const InputDecoration(
                    labelText: 'Type voiture',
                    hintText: 'Précise le type de voiture',
                    border: OutlineInputBorder(),
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
  ...
  Future<void> signChauffeur() async {
    final nom = nomController.text;
    final phone = telephoneController.text;
    final email = emailController.text;
    final typeVoiture = typevoituredController.text;
