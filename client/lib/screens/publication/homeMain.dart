...
class _HomeMainState extends State<HomeMain> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Historique publication'),
          centerTitle: true,
          automaticallyImplyLeading:
              false, //Supprime la flèche de retour dans l'Appbar
        ),
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  String formattedDate =
                      DateFormat('dd/MM/yyyy').format(datePub);
  ...
  Future<void> fetchPubs() async {
    final resp = await PubApi.fetchPubs();
